...
@pytest.mark.parametrize(
    'start, end, format, res', [
        ...
        (
            '2019-01-11', '2021-01-01', '%Y-%Q', ['2019-1', '2019-2', '2019-3', '2019-4', '2020-1', '2020-2', '2020-3', '2020-4']
        ),
        (
            '2021-10-11', '2022-01-01', '%Y-%Q', ['2021-4'],
        ),
        (
            '2021-08-13', '2021-10-11', '%Y-%Q', ['2021-3', '2021-4'],
        ),
        (
            '2019-01-11', '2021-01-01', '%Y-%H', ['2019-1', '2019-2',  '2020-1', '2020-2']
        ),
        (
            '2021-10-23', '2022-01-01', '%Y-%H', ['2021-2'],
        ),
        (
